...
export const VerTurnos = () => {
    ...
    useEffect(() => {
        // Agrupamos y ordenamos los turnos por fecha y hora
                            ...
                            {fechaVisible[fecha] && (
                                <ul className="space-y-4 mt-4">
                                    {turnosPorFecha.map((turno) => (
                                        <li
                                            key={turno.id}
                                            className={`p-6 border rounded-2xl flex flex-col justify-between items-center gap-4 shadow-lg border-l-8 ${turno.estado === 'disponible' ? 'bg-green-50  border-l-green-500' : 'bg-red-50 border-l-red-500'
                                                }`}
                                        >
