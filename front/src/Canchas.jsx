...
export const Canchas = ({ idCancha }) => {
  ...
  return (
    <section className="w-full min-h-screen flex flex-col items-center justify-around bg-gradient-to-b from-white via-green-50 to-green-400 p-5">
      ...
      <div className="w-full max-w-md bg-white rounded-3xl shadow-lg border border-green-300 p-4">
        <div className="flex flex-col gap-4">
          {canchas.map((cancha) => (
            <Link
              ...
              className="flex items-center gap-4 rounded-2xl p-4 shadow-md hover:shadow-lg hover:bg-green-100 transition-all duration-200 active:scale-95 group"
